...
void help()
{
	...
	cout.width(20);
	cout << left << "addpath a b"
		 << "Add an enviroment variable\n" ;
	cout.width(20);
	cout << left << "" << "a is the name of the variable\n";
	cout.width(20);
	cout << left << "" << "b is the value of the variable\n";
	cout.width(20);
	cout << left << "addpath a"
		 << "Delete environemt variable a\n";
	cout.width(20);
	cout << left << "open 'path'"
		 << "Open the file or folder\n";
	cout.width(20);
	cout << left << "" << "Ex: open cmd\n";
}
...
void add_path(char envname[], char envvalue[]) {
	if (envvalue == ""){
		cout << "The environment variable " <<envname<<" was deleted\n";
	}
	else {
		cout << "The environment variable " <<envname<<" was added\n";
	}
	strcat(envname, "=");
		strcat(envname, envvalue);
		putenv(envname);
}
