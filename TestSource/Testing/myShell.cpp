...
void runable(string command)
{
	...
	else if (command.find("addpath ") != std::string::npos){
		int a;
	...
	else if(command[0] == 'o' && command[1] == 'p' && command[2] =='e' && command[3] == 'n' && command[4] == ' '){
		char a[command.length() - 4];
		char c[0];
